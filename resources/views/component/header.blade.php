...
<link rel="stylesheet" href="{{ asset('css/adminlte.min.css') }}"><!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->
                ...
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open">
                            <a href="{{ url('/products/') }}" class="nav-link active"> <i class="nav-icon bi bi-speedometer"></i>
                                <p>
                                    All Products
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{ url('/products/create') }}" class="nav-link active"> <i class="nav-icon bi bi-speedometer"></i>
                                <p>
                                    Create Product
                                    <i class="nav-arrow bi bi-chevron-right"></i>
                                </p>
