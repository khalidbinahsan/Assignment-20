                    ...
                    <form action="{{ url('/products/'.$item->id) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="des" name="description">{{ $item->description }}</textarea>
                            </div>
                            <div class="mb-3">
                                <label for="product-id" class="form-label">Product ID</label>
                                <input type="text" class="form-control" id="product-id" name="product_id" value="{{ $item->product_id }}">
                            </div>
                            <div class="mb-3">
